...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'service-vehicle-operator', 'ev-car-owner'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Car Owners', path: '/car-owners', entity: 'car_owner', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
