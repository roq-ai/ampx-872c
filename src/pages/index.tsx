  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="AMPX - Ensuring your journey continues. Our service vehicles provide on-demand charging for your EV car, right where you need it. We connect you to the nearest charging station, making your road trips worry-free."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1593941707874-ef25b8b4a92b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxFViUyMGNoYXJnaW5nfGVufDB8fHx8MTY5NTQxNzgwOHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`AMPX - Ensuring your journey continues. Our service vehicles provide on-demand charging for your EV car, right where you need it. We connect you to the nearest charging station, making your road trips worry-free.`}
            </Text>
            <Box
