...
export function ProviderListPage(props: ProviderListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProviders({
        relations: ['user', 'service_vehicle.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['description.contains', 'address.contains', 'service_area.contains', 'name.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'service_area', header: 'Service Area', accessorKey: 'service_area' },
    ...
    hasAccess('service_vehicle', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.service_vehicle,
        }
      : null,
