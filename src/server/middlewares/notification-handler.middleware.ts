...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Service Vehicle Maintenance Completion.update': {
    roles: ['business-owner', 'ev-car-owner'],
    key: 'service_vehicle_maintenance_completion',
    tenantPath: [],
    userPath: [],
  },
  'EV Car Issue Report.create': {
    roles: ['business-owner', 'service-vehicle-operator'],
    key: 'ev_car_issue_report',
    tenantPath: [],
    userPath: [],
  },
  'Scheduled Maintenance Check.create': {
    roles: ['service-vehicle-operator'],
    key: 'scheduled_maintenance_check',
    tenantPath: [],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'service-vehicle-operator', 'ev-car-owner'];
